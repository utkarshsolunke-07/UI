...
export default function VideoStudio({ settings, setSettings }) {
  ...
  useEffect(() => {
    const render = () => {
      ...
      if (!canvas) { animIdRef.current = requestAnimationFrame(render); return; }
  ...
  }, [settings, isSample, tempVal, vignetteStr]);
      ...
      <div className="viewport-card" style={{ marginTop: '0.5rem' }}>
        ...
        >
          ...
          {viewMode === 'side-by-side' ? (
            /* ── Side-by-Side Dual Viewport Grid (DEFAULT) ── */
